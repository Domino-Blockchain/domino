---
title: Using Domino CLI
---

Before running any Domino CLI commands, let's go over some conventions that
you will see across all commands. First, the Domino CLI is actually a collection
...
`/home/domino/my_wallet.json`, to display the address, do:

```bash
domino-keygen pubkey /home/domino/my_wallet.json
```
