...
#[allow(deprecated)]
use domino_sdk::recent_blockhashes_account;
use {
    crate::{
    ...
    domino_metrics::{inc_new_counter_debug, inc_new_counter_info},
    domino_program_runtime::{
    ...
    domino_stake_program::stake_state::{
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
use domino_frozen_abi::abi_example::AbiExample;
...
impl Bank {
            ...
            stakes
                ...
                .for_each(|(stake_pubkey, delegation)| {
                    ...
                    let stake_delegation = match self.get_account_with_fixed_root(stake_pubkey) {
                        Some(stake_account) => {
                            if stake_account.owner() != &domino_stake_program::id() {
                                invalid_stake_keys
                        ...
                        vote_with_stake_delegations_map.get_mut(vote_pubkey)
                    {
                        ...
                        let vote_account = match self.get_account_with_fixed_root(vote_pubkey) {
                            Some(vote_account) => {
                                if vote_account.owner() != &domino_vote_program::id() {
                                    invalid_vote_keys
    ...
    pub fn add_precompiled_account(&self, program_id: &Pubkey) {
        ...
        let account = AccountSharedData::from(Account {
            lamports,
            owner: domino_sdk::system_program::id(),
            data: vec![],
            executable: true,
            rent_epoch,
        });
    ...
    fn use_multi_epoch_collection_cycle(&self, epoch: Epoch) -> bool {
        ...
        #[cfg(not(test))]
        if self.slot_count_per_normal_epoch() == domino_sdk::epoch_schedule::MINIMUM_SLOTS_PER_EPOCH
        {
            return false;
        }
    ...
    fn reconfigure_token2_native_mint(&mut self) {
        ...
        if reconfigure_token2_native_mint {
            let mut native_mint_account = domino_sdk::account::AccountSharedData::from(Account {
                owner: inline_spl_token::id(),
                data: inline_spl_token::native_mint::ACCOUNT_DATA.to_vec(),
                lamports: dom_to_lamports(1.),
                executable: false,
            ...
            {
                if existing_native_mint_account.owner() == &domino_sdk::system_program::id() {
...
pub fn is_simple_vote_transaction(transaction: &SanitizedTransaction) -> bool {
    if transaction.message().instructions().len() == 1 {
        let (program_pubkey, instruction) = transaction
            ...
            .next()
            .unwrap();
        if program_pubkey == &domino_vote_program::id() {
...
pub(crate) mod tests {
    #[allow(deprecated)]
    use domino_sdk::sysvar::fees::Fees;
    use {
        super::*,
        crate::{
    ...
    #[allow(clippy::float_cmp)]
    fn test_bank_new() {
        let dummy_leader_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_store_account_and_update_capitalization_missing() {
        ...
        let bank = Bank::new_for_tests(&genesis_config);
        let pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_rent_distribution() {
        ...
        let bootstrap_validator_pubkey = domino_sdk::pubkey::new_rand();
        ...
        let validator_1_pubkey = domino_sdk::pubkey::new_rand();
        ...
        let validator_2_pubkey = domino_sdk::pubkey::new_rand();
        ...
        let validator_3_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_distribute_rent_to_validators_overflow() {
        ...
        let validator_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_rent_exempt_executable_account() {
        ...
        let account_pubkey = domino_sdk::pubkey::new_rand();
        let account_balance = 1;
        let mut account =
            AccountSharedData::new(account_balance, 0, &domino_sdk::pubkey::new_rand());
    ...
    fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
        let leader_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn map_to_test_bad_range() -> std::collections::BTreeMap<Pubkey, i8> {
        ...
        map.insert(domino_sdk::pubkey::new_rand(), 1);
        map
    }
    ...
    fn test_rent_eager_collect_rent_in_partition() {
        ...
        let zero_lamport_pubkey = domino_sdk::pubkey::new_rand();
        let rent_due_pubkey = domino_sdk::pubkey::new_rand();
        let rent_exempt_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn do_test_bank_update_rewards_determinism() -> u64 {
        ...
        let vote_id = domino_sdk::pubkey::new_rand();
        let mut vote_account =
            vote_state::create_account(&vote_id, &domino_sdk::pubkey::new_rand(), 50, 100);
    ...
    fn test_one_source_two_tx_one_batch() {
        ...
        let key1 = domino_sdk::pubkey::new_rand();
        let key2 = domino_sdk::pubkey::new_rand();
        let bank = Bank::new_for_tests(&genesis_config);
        assert_eq!(bank.last_blockhash(), genesis_config.hash());
    ...
    fn test_transfer_to_sysvar() {
        ...
        let normal_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_tx_fee() {
        ...
        let leader = domino_sdk::pubkey::new_rand();
        let GenesisConfigInfo {
            mut genesis_config,
            mint_keypair,
            ..
    ...
    fn test_readonly_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &domino_sdk::pubkey::new_rand(), 0);
        let bank = Bank::new_for_tests(&genesis_config);

        let vote_pubkey0 = domino_sdk::pubkey::new_rand();
        let vote_pubkey1 = domino_sdk::pubkey::new_rand();
        let vote_pubkey2 = domino_sdk::pubkey::new_rand();
    ...
    fn test_readonly_relaxed_locks() {
        ...
        let key3 = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state() {
        ...
        let pubkey2 = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state_verify() {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &domino_sdk::pubkey::new_rand(), 1);
        ...
        bank2.update_accounts_hash();
        assert!(bank2.verify_bank_hash(true));
        let bank3 = Bank::new_from_parent(&bank0, &domino_sdk::pubkey::new_rand(), 2);
    ...
    fn test_hash_internal_state_order() {
        ...
        let bank1 = Bank::new_for_tests(&genesis_config);
        assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
        let key0 = domino_sdk::pubkey::new_rand();
        let key1 = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_update_sysvar_account() {
        ...
        let dummy_clock_id = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_inherit_tx_count() {
        ...
        // Bank 2
        let bank2 = Bank::new_from_parent(&bank0, &domino_sdk::pubkey::new_rand(), 2);
        ...
        let bank6 = Bank::new_from_parent(&bank1, &domino_sdk::pubkey::new_rand(), 3);
        assert_eq!(bank1.transaction_count(), 1);
    ...
    fn test_bank_vote_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &domino_sdk::pubkey::new_rand(), 1);
        let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    ...
    fn test_is_delta_with_no_committables() {
        ...
        assert_eq!(
            bank.transfer(10_001, &mint_keypair, &domino_sdk::pubkey::new_rand()),
            Err(TransactionError::InstructionError(
                0,
                SystemError::ResultWithNegativeLamports.into(),
            ))
    ...
    fn test_bank_get_program_accounts() {
        ...
        assert!(
            genesis_accounts
                .iter()
                .any(|(pubkey, _, _)| domino_sdk::sysvar::is_sysvar_id(pubkey)),
            "no sysvars found"
        );

        let bank0 = Arc::new(new_from_parent(&parent));
        let pubkey0 = domino_sdk::pubkey::new_rand();
        ...
        let pubkey1 = domino_sdk::pubkey::new_rand();
    ...
    fn test_add_duplicate_static_program() {
        ...
        let vote_loader_account = bank.get_account(&domino_vote_program::id()).unwrap();
        bank.add_builtin(
            "domino_vote_program",
            &domino_vote_program::id(),
            mock_vote_processor,
        );
        let new_vote_loader_account = bank.get_account(&domino_vote_program::id()).unwrap();
    ...
    fn test_transaction_with_duplicate_accounts_in_instruction() {
        ...
        let from_pubkey = domino_sdk::pubkey::new_rand();
        let to_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_account_ids_after_program_ids() {
        ...
        let instruction =
            Instruction::new_with_bincode(domino_vote_program::id(), &10, account_metas);
        let mut tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
        ...
        tx.message.account_keys.push(domino_sdk::pubkey::new_rand());
        ...
        let result = bank.process_transaction(&tx);
        assert_eq!(result, Ok(()));
        let account = bank.get_account(&domino_vote_program::id()).unwrap();
    ...
    fn test_program_id_as_payer() {
        ...
        tx.message.account_keys.push(domino_vote_program::id());
    ...
    fn test_fuzz_instructions() {
        ...
        let program_keys: Vec<_> = (0..max_programs)
            .enumerate()
            .map(|i| {
                let key = domino_sdk::pubkey::new_rand();
    ...
    fn test_same_program_id_uses_unqiue_executable_accounts() {
        ...
        // Add a new program
        let program1_pubkey = domino_sdk::pubkey::new_rand();
        bank.add_builtin("program", &program1_pubkey, nested_processor);

        // Add a new program owned by the first
        let program2_pubkey = domino_sdk::pubkey::new_rand();
    ...
    fn test_add_builtin_no_overwrite() {
        ...
        let slot = 123;
        let program_id = domino_sdk::pubkey::new_rand();
    ...
    fn test_add_builtin_loader_no_overwrite() {
        ...
        let slot = 123;
        let loader_id = domino_sdk::pubkey::new_rand();
    ...
    fn test_reconfigure_token2_native_mint() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(5, &domino_sdk::pubkey::new_rand(), 0).genesis_config;
    ...
    fn test_ensure_no_storage_rewards_pool() {
        ...
        let reward_pubkey = domino_sdk::pubkey::new_rand();
        genesis_config.rewards_pools.insert(
            reward_pubkey,
            Account::new(u64::MAX, 0, &domino_sdk::pubkey::new_rand()),
        );
        let bank0 = Bank::new_for_tests(&genesis_config);
    ...
    fn test_cached_executors() {
        ...
        let key2 = domino_sdk::pubkey::new_rand();
        let key3 = domino_sdk::pubkey::new_rand();
        let key4 = domino_sdk::pubkey::new_rand();
    ...
    fn test_bank_executor_cache() {
        ...
        // Check inheritance
        let bank = Bank::new_from_parent(&Arc::new(bank), &domino_sdk::pubkey::new_rand(), 1);
        let executors = bank.get_executors(&message, accounts, program_indices);
        assert_eq!(executors.borrow().executors.len(), 4);
        assert!(executors.borrow().executors.contains_key(&key1));
        assert!(executors.borrow().executors.contains_key(&key2));
    ...
    fn test_rent_for_sysvars_adjustment_full_set() {
        ...
        fn mock_process_instruction(
            ...
            _data: &[u8],
            _invoke_context: &mut InvokeContext,
        ) -> std::result::Result<(), domino_sdk::instruction::InstructionError> {
            Ok(())
        }
            ...
            ) + std::marker::Send,
    {
        ...
        let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(domino_sdk::pubkey::new_rand)
            .take(total_pubkeys)
            .collect();
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        let GenesisConfigInfo {
            mut genesis_config, ..
        } = create_genesis_config_with_leader(42, &domino_sdk::pubkey::new_rand(), 42);
        genesis_config
            .accounts
    ...
    fn test_get_largest_accounts() {
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &pubkeys_hashset, AccountAddressFilter::Include)
                .unwrap(),
            vec![(pubkeys[4], dom_to_lamports(5.0))]
        );
        assert_eq!(
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &exclude4, AccountAddressFilter::Exclude)
                .unwrap(),
            vec![(pubkeys[3], dom_to_lamports(4.0))]
        );
    ...
    fn test_transfer_sysvar() {
        ...
        fn mock_ix_processor(
            ...
            use domino_sdk::account::WritableAccount;
            let keyed_accounts = invoke_context.get_keyed_accounts()?;
    ...
    fn test_call_precomiled_program() {
        ...
        let instruction = domino_sdk::secp256k1_instruction::new_secp256k1_instruction(
            &secp_privkey,
            message_arr,
        );
        let tx = Transaction::new_signed_with_payer(
        ...
        let message_arr = b"hello";
        let instruction =
            domino_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
        let tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
    ...
    fn test_an_empty_instruction_without_program() {
        let (genesis_config, mint_keypair) = create_genesis_config(1);
        let destination = domino_sdk::pubkey::new_rand();
