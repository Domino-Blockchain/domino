...
cat >/etc/apt/apt.conf.d/99-domino <<'EOF'
...
"$DOMINO_ROOT"/net/scripts/install-docker.sh
usermod -aG docker "$SETUP_USER"
"$DOMINO_ROOT"/net/scripts/install-certbot.sh
...
"$DOMINO_ROOT"/net/scripts/install-earlyoom.sh
"$DOMINO_ROOT"/net/scripts/install-nodejs.sh
"$DOMINO_ROOT"/net/scripts/localtime.sh
"$DOMINO_ROOT"/net/scripts/install-redis.sh
"$DOMINO_ROOT"/net/scripts/install-rsync.sh
"$DOMINO_ROOT"/net/scripts/install-libssl-compatability.sh
