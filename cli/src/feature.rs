use {
    ...
    domino_clap_utils::{input_parsers::*, input_validators::*, keypair::*},
    domino_cli_output::{QuietDisplay, VerboseDisplay},
    domino_client::{client_error::ClientError, rpc_client::RpcClient},
...
fn feature_activation_allowed(rpc_client: &RpcClient, quiet: bool) -> Result<bool, ClientError> {
    let my_feature_set = domino_version::Version::default().feature_set;
