...
#[deprecated(
    since = "1.8.0",
    note = "Please use `domino_sdk::stake::config` or `domino_program::stake::config` instead"
)]
pub use domino_sdk::stake::config::*;
use {
    bincode::deserialize,
    domino_config_program::{create_config_account, get_config_data},
    domino_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, domino_sdk::pubkey::Pubkey, std::cell::RefCell};
