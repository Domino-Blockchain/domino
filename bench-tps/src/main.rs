...
use {
    ...
    domino_genesis::Base64Account,
    domino_gossip::gossip_service::{discover_cluster, get_client, get_multi_client},
    domino_sdk::{
...
fn main() {
    ...
    domino_metrics::set_panic_hook("bench-tps");

    let matches = cli::build_args(domino_version::version!()).get_matches();
