#[allow(deprecated)]
use domino_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    #[allow(deprecated)]
    use domino_sdk::sysvar::recent_blockhashes::IterItem;
    use {
        super::*,
        domino_sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = domino_sdk::pubkey::new_rand();
