...
pub enum LedgerError {
    #[error("Domino app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Domino message")]
    DominoInvalidMessage = 0x6a80,

    #[error("Domino summary finalization failed on Ledger device")]
    DominoSummaryFinalizeFailed = 0x6f00,

    #[error("Domino summary update failed on Ledger device")]
    DominoSummaryUpdateFailed = 0x6f01,
