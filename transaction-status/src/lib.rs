...
pub use {crate::extract_memos::extract_and_fmt_memos, domino_runtime::bank::RewardType};
use {
    crate::{
...
pub struct UiTransactionStatusMeta {
    ...
    pub status: Result<()>, // This field is deprecated.  See https://github.com/Domino-Blockchain/domino/issues/9302
    pub fee: u64,
    pub pre_balances: Vec<u64>,
    pub post_balances: Vec<u64>,
