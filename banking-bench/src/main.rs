...
use {
    ...
    rand::{thread_rng, Rng},
    rayon::prelude::*,
    domino_core::banking_stage::BankingStage,
    ...
    domino_poh::poh_recorder::{create_test_recorder, PohRecorder, WorkingBankEntry},
    domino_runtime::{
...
fn make_accounts_txs(
    ...
    (0..total_num_transactions)
        ...
        .map(|_| {
            ...
            if !same_payer {
                new.message.account_keys[0] = domino_sdk::pubkey::new_rand();
            }
            new.message.account_keys[1] = domino_sdk::pubkey::new_rand();
...
fn main() {
    ...
    let ledger_path = get_tmp_ledger_path!();
    {
        ...
        let mut root = 1;
        let collector = domino_sdk::pubkey::new_rand();
        let config = Config {
