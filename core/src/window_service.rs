...
use {
    ...
    domino_perf::packet::{Packet, PacketBatch},
    domino_rayon_threadlimit::get_thread_count,
    domino_runtime::{bank::Bank, bank_forks::BankForks},
    domino_sdk::{clock::Slot, packet::PACKET_DATA_SIZE, pubkey::Pubkey},
    std::{
        cmp::Reverse,
...
impl WindowService {
    ...
    fn start_check_duplicate_thread(
        ...
        let handle_error = || {
            inc_new_counter_error!("domino-check-duplicate-error", 1, 1);
        };
        Builder::new()
            .name("domino-check-duplicate".to_string())
            .spawn(move || loop {
    ...
    fn start_window_insert_thread(
        ...
        let handle_error = || {
            inc_new_counter_error!("domino-window-insert-error", 1, 1);
        };

        Builder::new()
            .name("domino-window-insert".to_string())
            .spawn(move || {
            ...
            + std::marker::Sync,
    {
        ...
        Builder::new()
            ...
            .spawn(move || {
                ...
                let handle_error = || {
                    inc_new_counter_error!("domino-window-error", 1, 1);
                };
...
mod test {
    ...
    fn test_should_retransmit_and_persist() {
        let me_id = domino_sdk::pubkey::new_rand();
