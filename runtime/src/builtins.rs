...
fn genesis_builtins() -> Vec<Builtin> {
    vec![
        ...
        Builtin::new(
            ...
            with_program_logging!(domino_vote_program::vote_instruction::process_instruction),
        ),
        Builtin::new(
            "stake_program",
            stake::program::id(),
            with_program_logging!(domino_stake_program::stake_instruction::process_instruction),
        ),
        Builtin::new(
            "config_program",
            domino_config_program::id(),
            with_program_logging!(domino_config_program::config_processor::process_instruction),
        ),
        Builtin::new(
            "secp256k1_program",
            domino_sdk::secp256k1_program::id(),
...
/// https://github.com/Domino-Blockchain/domino/blob/84b139cc94b5be7c9e0c18c2ad91743231b85a0d/runtime/src/bank.rs#L1723
fn feature_builtins() -> Vec<(Builtin, Pubkey, ActivationType)> {
    vec![
        (
            Builtin::new(
                "compute_budget_program",
                domino_sdk::compute_budget::id(),
                domino_compute_budget_program::process_instruction,
            ),
        ...
        (
            Builtin::new(
                ...
                domino_address_lookup_table_program::id(),
                domino_address_lookup_table_program::processor::process_instruction,
            ),
