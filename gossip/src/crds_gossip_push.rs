...
use {
    ...
    domino_sdk::{packet::PACKET_DATA_SIZE, pubkey::Pubkey, timing::timestamp},
...
mod test {
    ...
    fn test_prune() {
        ...
        let self_id = domino_sdk::pubkey::new_rand();
        let origin = domino_sdk::pubkey::new_rand();
        ...
        let low_staked_peers = (0..10).map(|_| domino_sdk::pubkey::new_rand());
        ...
        let high_staked_peer = domino_sdk::pubkey::new_rand();
    ...
    fn test_process_push_old_version() {
        let crds = RwLock::<Crds>::default();
        let push = CrdsGossipPush::default();
        let mut ci = ContactInfo::new_localhost(&domino_sdk::pubkey::new_rand(), 0);
        ci.wallclock = 1;
    ...
    fn test_refresh_active_set() {
        ...
        for _ in 0..push.num_active {
            let value2 = CrdsValue::new_unsigned(CrdsData::ContactInfo(
                ContactInfo::new_localhost(&domino_sdk::pubkey::new_rand(), 0),
            ));
            assert_eq!(
                crds.write()
                    .unwrap()
