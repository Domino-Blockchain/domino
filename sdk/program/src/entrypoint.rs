//! Domino Rust-based BPF program entry point supported by the latest
...
/// errors. To avoid this, it is common for Domino programs to define an
...
///
/// # Defining a panic handler for Domino
///
/// _The mechanism for defining a Domino panic handler is different [from most
...
/// ```
///
/// The above is how Domino defines the default panic handler.
#[macro_export]
