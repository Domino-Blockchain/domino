...
extern crate domino_core;
extern crate test;

use {
    log::*,
    domino_core::retransmit_stage::retransmitter,
...
// the case since https://github.com/Domino-Blockchain/domino/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // domino_rpc::max_slots::MaxSlots
        None,
    );
