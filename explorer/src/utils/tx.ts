...
import { TokenInfoMap } from "@domino/spl-token-registry";
...
export enum PROGRAM_NAMES {
  ...
  BREAK_DOMINO = "Break Domino Program",
  ...
  DOMIEND = "Solend Program",
  DOMIIDO = "Lido for Domino Program",
...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.BREAK_DOMINO]: LIVE_CLUSTERS,
  ...
  [PROGRAM_NAMES.DOMIEND]: MAINNET_ONLY,
  [PROGRAM_NAMES.DOMIIDO]: MAINNET_ONLY,
...
export const PROGRAM_NAME_BY_ID = {
  ...
  BrEAK7zGZ6dM71zUDACDqJnekihmwF15noTddWTsknjC: PROGRAM_NAMES.BREAK_DOMINO,
  ...
  So1endDq2YkqhipRh3WViPa8hdiSpxWy6z3Z6tMCpAo: PROGRAM_NAMES.DOMIEND,
  CrX7kMhLC3cSsXJdT7JDgqrRVWGnUpX3gfEfxxU2NVLi: PROGRAM_NAMES.DOMIIDO,
