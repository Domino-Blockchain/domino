...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        ...
        (domino_sdk::stake::config::id(), COMPUTE_UNIT_TO_US_RATIO * 2),
        (domino_sdk::stake::program::id(), COMPUTE_UNIT_TO_US_RATIO * 25),
        (domino_config_program::id(), COMPUTE_UNIT_TO_US_RATIO * 15),
        (domino_vote_program::id(), COMPUTE_UNIT_TO_US_RATIO * 85),
