use {
    ...
    bincode::deserialize,
    serde_json::Value,
    domino_config_program::{get_config_data, ConfigKeys},
    domino_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        domino_config_program::create_config_account, domino_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = domino_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Domino"}"#).unwrap(),
            }),
        );
