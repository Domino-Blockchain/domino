#pragma once
/**
 * @brief Domino program entrypoint
 */
...
/**
 * The Domino runtime provides a memory region that is available to programs at
 * a fixed virtual address and length. The builtin functions `dom_calloc` and
 * `dom_free` call into the Domino runtime to allocate from this memory region
 ...
 *
 * @param input Buffer of serialized input parameters.  Use dom_deserialize() to decode
