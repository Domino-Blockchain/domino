...
of the [Domino Labs](https://hub.docker.com/u/dominolabs/) Docker Hub
organization.
...
1. Run `DOMINO_ALLOCATE_TTY=1 DOMINO_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull dominolabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `DOMINO_ALLOCATE_TTY=1 DOMINO_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull dominolabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
