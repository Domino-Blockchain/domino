//! Types for directing the execution of Domino programs.
//!
//! Every invocation of a Domino program executes a single instruction, as
...
//! the Domino runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Domino runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Domino software versions.
    ///
...
/// A directive for a single invocation of a Domino program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Domino
...
/// construction.
///
/// While Domino is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Domino runtime coalesces all accounts used
...
///
/// Note that because the Domino runtime schedules parallel transaction
...
/// which is the core of a Domino transaction. It is created during the
