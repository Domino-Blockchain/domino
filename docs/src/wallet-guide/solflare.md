...
specifically for Domino.
SolFlare supports sending and receiving native DOMI tokens as well as sending and
receiving SPL Tokens (Domino's ERC-20 equivalent).
SolFlare also supports staking of DOMI tokens.
...
receive DOMI tokens, and how to create and manage a stake account.
...
funds in that wallet will be lost permanently. Neither the Domino team nor the
...
the Domino app](ledger-live.md#upgrade-to-the-latest-version-of-the-domino-app)
on your device.

#### Select a Ledger address to access

Plug in your Nano and open the Domino app so the device screen displays
...
Domino maintains [three distinct networks](../clusters), each of which has
its own purpose in supporting the Domino ecosystem. Mainnet Beta is selected by
...
## Sending and Receiving DOMI Tokens
...
wallet address or an exchange deposit address by clicking "Transfer DOMI" in the
upper-right corner. Enter the recipient address and the amount of DOMI to
...
about how staking on Domino works in general, check out our
[Staking Guide](../staking).

### Create a Stake Account

You can use some of the DOMI tokens in your wallet to create a new stake account.
From the wallet main page click "Staking" at the top of the page. In the upper-
right, click "Create Account". Enter the amount of DOMI you want to use to
...
associated with your stake account. Consider leaving at least 1 DOMI in your
wallet account.
...
click "Split". Specify the amount of DOMI tokens you want to split. This will be
