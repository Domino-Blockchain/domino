...
domino-bench-tps)
  net/scripts/rsync-retry.sh -vPrc \
    "$entrypointIp":~/domino/config/bench-tps"$clientIndex".yml ./client-accounts.yml
  clientCommand="\
    domino-bench-tps \
...
idle)
  ...
  net/scripts/rsync-retry.sh -vPrc \
    "$entrypointIp":~/domino/config/faucet.json ~/domino/
  exit 0
  ;;
*)
...
echo "@reboot ~/domino/on-reboot" | crontab -
