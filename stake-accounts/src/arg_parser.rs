...
fn fee_payer_arg<'a, 'b>() -> Arg<'a, 'b> {
    domino_clap_utils::fee_payer::fee_payer_arg().required(true)
}
            ...
            SubCommand::with_name("new")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("Amount to move into the new stake accounts, in DOMI"),
                )
                .arg(
                    Arg::with_name("stake_authority")
                        .long("stake-authority")
...
fn parse_new_args(matches: &ArgMatches<'_>) -> NewArgs<String, String> {
    NewArgs {
        ...
        lamports: dom_to_lamports(value_t_or_exit!(matches, "amount", f64)),
