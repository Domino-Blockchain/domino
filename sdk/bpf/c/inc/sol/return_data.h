#pragma once
/**
 * @brief Domino return data system calls
**/
 ...
 */
void dom_set_return_data(const uint8_t *bytes, uint64_t bytes_len);
 ...
 */
uint64_t dom_get_return_data(const uint8_t *bytes, uint64_t bytes_len, SolPubkey *program_id);
