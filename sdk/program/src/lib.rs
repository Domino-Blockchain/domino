...
// Allows macro expansion of `use ::domino_program::*` to work within this crate
extern crate self as domino_program;
...
#[cfg(target_arch = "bpf")]
pub use domino_sdk_macro::wasm_bindgen_stub as wasm_bindgen;
...
pub use domino_sdk_macro::program_declare_deprecated_id as declare_deprecated_id;
...
/// use std::str::FromStr;
/// use domino_program::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use domino_program::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use domino_sdk_macro::program_declare_id as declare_id;
...
/// ```
/// use std::str::FromStr;
/// use domino_program::{pubkey, pubkey::Pubkey};
///
...
/// assert_eq!(ID, my_id);
/// ```
pub use domino_sdk_macro::program_pubkey as pubkey;

#[macro_use]
extern crate serde_derive;

#[macro_use]
extern crate domino_frozen_abi_macro;
...
/// ```compile_fail
/// # use domino_program::unchecked_div_by_const;
/// # fn main() {
