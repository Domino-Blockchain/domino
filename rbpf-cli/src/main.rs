use {
    ...
    domino_sdk::{account::AccountSharedData, bpf_loader, pubkey::Pubkey},
    std::{
        fs::File,
...
fn main() {
    domino_logger::setup();
    let matches = App::new("Domino BPF CLI")
        .version(crate_version!())
        .author("Domino Maintainers <maintainers@domino.foundation>")
        .about(
