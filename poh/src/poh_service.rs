...
impl PohService {
    pub fn new(
        ...
        let tick_producer = Builder::new()
            .name("domino-poh-service-tick_producer".to_string())
            .spawn(move || {
                domino_sys_tuner::request_realtime_poh();
    ...
    fn test_poh_service() {
        ...
        let ledger_path = get_tmp_ledger_path!();
        {
            ...
            let entry_producer = {
                ...
                Builder::new()
                    .name("domino-poh-service-entry_producer".to_string())
                    .spawn(move || {
                        let now = Instant::now();
                        let mut total_us = 0;
