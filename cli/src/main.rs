use {
    ...
    domino_cli_config::Config,
    domino_cli_output::{display::println_name_value, OutputFormat},
    domino_client::rpc_config::RpcSendTransactionConfig,
...
fn main() -> Result<(), Box<dyn error::Error>> {
    domino_logger::setup_with_default("off");
