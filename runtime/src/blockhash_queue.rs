#[allow(deprecated)]
use domino_sdk::sysvar::recent_blockhashes;
use {
    serde::{Deserialize, Serialize},
    domino_sdk::{fee_calculator::FeeCalculator, hash::Hash, timing::timestamp},
...
mod tests {
    ...
    use {
        super::*,
        bincode::serialize,
        domino_sdk::{clock::MAX_RECENT_BLOCKHASHES, hash::hash},
    };
