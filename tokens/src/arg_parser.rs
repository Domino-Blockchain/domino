use {
    ...
    domino_cli_config::CONFIG_FILE,
    domino_remote_wallet::remote_wallet::maybe_wallet_manager,
    domino_sdk::native_token::dom_to_lamports,
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. http://api.devnet.dominochain.com"),
        )
        .subcommand(
            SubCommand::with_name("distribute-tokens")
                .about("Distribute DOMI")
                .arg(
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in DOMI"),
                )
                .arg(
            ...
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_domi")
                        ...
                        .long("unlocked-domi")
                        .takes_value(true)
                        .value_name("DOMI_AMOUNT")
                        .help("Amount of DOMI to put in system account to pay for fees"),
                )
                .arg(
...
fn parse_distribute_tokens_args(
    ...
    Ok(DistributeTokensArgs {
        ...
        stake_args: None,
        spl_token_args: None,
        transfer_amount: value_of(matches, "transfer_amount").map(dom_to_lamports),
    })
}
