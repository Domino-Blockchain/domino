---
title: Domino Wallet Guide
---

This document describes the different wallet options that are available to users
of Domino who want to be able to send, receive and interact with
DOMI tokens on the Domino blockchain.
...
Domino supports multiple types of wallets so you can choose the right balance
of security and convenience.

**If you want to be able to receive DOMI tokens on the Domino blockchain,
you first will need to create a wallet.**

## Supported Wallets

Domino supports several types of wallets in the Domino native
...
may be more appropriate, as new features on the Domino blockchain will always be
