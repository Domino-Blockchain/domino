...
#[macro_use]
extern crate domino_bpf_loader_program;

use itertools::izip;
use log::{log_enabled, trace, Level::Trace};
use domino_account_decoder::parse_bpf_loader::{
    parse_bpf_upgradeable_loader, BpfUpgradeableLoaderAccountType,
};
use domino_bpf_loader_program::{
    create_vm,
    serialization::{deserialize_parameters, serialize_parameters},
    syscalls::register_syscalls,
    BpfError, ThisInstructionMeter,
};
use domino_bpf_rust_invoke::instructions::*;
use domino_bpf_rust_realloc::instructions::*;
...
fn test_program_bpf_sanity() {
    ...
    {
        programs.extend_from_slice(&[
            ("domino_bpf_rust_128bit", true),
            ("domino_bpf_rust_alloc", true),
            ("domino_bpf_rust_custom_heap", true),
            ("domino_bpf_rust_dep_crate", true),
            ("domino_bpf_rust_external_spend", false),
            ("domino_bpf_rust_iter", true),
            ("domino_bpf_rust_many_args", true),
            ("domino_bpf_rust_membuiltins", true),
            ("domino_bpf_rust_noop", true),
            ("domino_bpf_rust_panic", false),
            ("domino_bpf_rust_param_passing", true),
            ("domino_bpf_rust_rand", true),
            ("domino_bpf_rust_sanity", true),
            ("domino_bpf_rust_secp256k1_recover", true),
            ("domino_bpf_rust_sha", true),
        ]);
    }
    ...
    for program in programs.iter() {
        ...
        let (name, id, entrypoint) = domino_bpf_loader_program!();
...
fn test_program_bpf_loader_deprecated() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("domino_bpf_rust_deprecated_loader")]);
    }
    ...
    for program in programs.iter() {
        ...
        let mut bank = Bank::new_for_tests(&genesis_config);
        let (name, id, entrypoint) = domino_bpf_loader_deprecated_program!();
        bank.add_builtin(&name, &id, entrypoint);
        let bank_client = BankClient::new(bank);
...
fn test_program_bpf_duplicate_accounts() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("domino_bpf_rust_dup_accounts")]);
    }
...
fn test_program_bpf_error_handling() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("domino_bpf_rust_error_handling")]);
    }
...
fn test_return_data_and_log_data_syscall() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("domino_bpf_rust_log_data")]);
    }
...
fn test_program_bpf_invoke_sanity() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.push((
            Languages::Rust,
            "domino_bpf_rust_invoke",
            "domino_bpf_rust_invoked",
            "domino_bpf_rust_noop",
        ));
    }
    for program in programs.iter() {
        println!("Test program: {:?}", program);
        ...
        let account_metas = vec![
            ...
            AccountMeta::new_readonly(domino_sdk::ed25519_program::id(), false),
...
fn test_program_bpf_program_id_spoofing() {
    ...
    let malicious_swap_pubkey = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_spoof1",
    );
    let malicious_system_pubkey = load_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_spoof1_system",
    );
...
fn assert_instruction_count() {
    ...
    {
        programs.extend_from_slice(&[
            ("domino_bpf_rust_128bit", 584),
            ("domino_bpf_rust_alloc", 7388),
            ("domino_bpf_rust_custom_heap", 536),
            ("domino_bpf_rust_dep_crate", 47),
            ("domino_bpf_rust_external_spend", 507),
            ("domino_bpf_rust_iter", 824),
            ("domino_bpf_rust_many_args", 941),
            ("domino_bpf_rust_mem", 3086),
            ("domino_bpf_rust_membuiltins", 3976),
            ("domino_bpf_rust_noop", 481),
            ("domino_bpf_rust_param_passing", 146),
            ("domino_bpf_rust_rand", 488),
            ("domino_bpf_rust_sanity", 8455),
            ("domino_bpf_rust_secp256k1_recover", 25216),
            ("domino_bpf_rust_sha", 30692),
        ]);
    }
...
fn test_program_bpf_instruction_introspection() {
    ...
    let program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_instruction_introspection",
    );
...
fn test_program_bpf_test_use_latest_executor() {
    ...
    let panic_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_panic",
    );

    let program_keypair = Keypair::new();

    // Write the panic program into the program account
    let elf = read_bpf_program("domino_bpf_rust_panic");
    let message = Message::new(
    ...
    let elf = read_bpf_program("domino_bpf_rust_noop");
    write_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
...
fn test_program_bpf_test_use_latest_executor2() {
    ...
    let invoke_and_error = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_invoke_and_error",
    );
    let invoke_and_ok = load_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_invoke_and_ok",
    );
...
fn test_program_bpf_upgrade() {
    ...
    let mut bank = Bank::new_for_tests(&genesis_config);
    let (name, id, entrypoint) = domino_bpf_loader_upgradeable_program!();
    bank.add_builtin(&name, &id, entrypoint);
    let bank_client = BankClient::new(bank);
...
fn test_program_bpf_invoke_upgradeable_via_cpi() {
    ...
    let invoke_and_return = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_invoke_and_return",
    );
...
fn test_program_bpf_disguised_as_bpf_loader() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("domino_bpf_rust_noop")]);
    }
...
fn test_program_bpf_upgrade_via_cpi() {
    ...
    let path = create_bpf_path("domino_bpf_rust_upgraded");
    let mut file = File::open(&path).unwrap_or_else(|err| {
        panic!("Failed to open {}: {}", path.display(), err);
    });
    let mut elf = Vec::new();
...
fn test_program_upgradeable_locks() {
    fn setup_program_upgradeable_locks(
        ...
        // Load the buffer account
        let path = create_bpf_path("domino_bpf_rust_noop");
        let mut file = File::open(&path).unwrap_or_else(|err| {
            panic!("Failed to open {}: {}", path.display(), err);
        });
        let mut elf = Vec::new();
...
fn test_program_bpf_ro_account_modify() {
    ...
    let program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_ro_account_modify",
    );
...
fn test_program_bpf_realloc() {
    ...
    assert_eq!(&domino_sdk::system_program::id(), account.owner());
    let data = bank_client.get_account_data(&pubkey).unwrap().unwrap();
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            ...
                            AccountMeta::new(domino_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
...
fn test_program_bpf_realloc_invoke() {
    ...
    let realloc_invoke_program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "domino_bpf_rust_realloc_invoke",
    );
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            AccountMeta::new(pubkey, true),
                            AccountMeta::new_readonly(realloc_program_id, false),
                            AccountMeta::new_readonly(domino_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
