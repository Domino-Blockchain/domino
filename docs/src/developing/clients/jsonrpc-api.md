...
- `err: <object | string | null>` - Error if transaction failed, null if transaction succeeded. [TransactionError definitions](https://github.com/Domino-Blockchain/domino/blob/master/sdk/src/transaction.rs#L24)
