...
identity=$DOMINO_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$DOMINO_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$DOMINO_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
