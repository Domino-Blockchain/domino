...
impl<'a> InvokeContext<'a> {
    ...
    fn process_executable_chain(
        ...
        if domino_sdk::native_loader::check_id(owner_id) {
...
pub fn with_mock_invoke_context<R, F: FnMut(&mut InvokeContext) -> R>(
    ...
    let keyed_accounts = [
        (
            ...
            false,
            loader_id,
            AccountSharedData::new_ref(0, 0, &domino_sdk::native_loader::id()),
        ),
        (
            false,
            false,
...
pub fn mock_process_instruction_with_sysvars(
    ...
    let processor_account = AccountSharedData::new_ref(0, 0, &domino_sdk::native_loader::id());
...
mod tests {
    ...
    fn test_program_entry_debug() {
        ...
        let builtin_programs = &[
            BuiltinProgram {
                program_id: domino_sdk::pubkey::new_rand(),
    ...
    fn test_invoke_context() {
        ...
        for i in 0..MAX_DEPTH {
            invoke_stack.push(domino_sdk::pubkey::new_rand());
            accounts.push((
            ...
            accounts.push((
                *program_id,
                Rc::new(RefCell::new(AccountSharedData::new(
                    1,
                    1,
                    &domino_sdk::pubkey::Pubkey::default(),
                ))),
            ));
    ...
    fn test_process_cross_program() {
        let caller_program_id = domino_sdk::pubkey::new_rand();
        let callee_program_id = domino_sdk::pubkey::new_rand();

        let owned_account = AccountSharedData::new(42, 1, &callee_program_id);
        let not_owned_account = AccountSharedData::new(84, 1, &domino_sdk::pubkey::new_rand());
        let readonly_account = AccountSharedData::new(168, 1, &domino_sdk::pubkey::new_rand());
