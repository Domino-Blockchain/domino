use {
    ...
    domino_sdk::{clock::Slot, hash::Hash},
...
mod test {
    use {
        super::*, crate::vote_simulator::VoteSimulator, domino_ledger::get_tmp_ledger_path,
        domino_runtime::bank::Bank, domino_sdk::pubkey::Pubkey, std::collections::HashMap,
        trees::tr,
    };
