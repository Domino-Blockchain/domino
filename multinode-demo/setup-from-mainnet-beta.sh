...
rm -rf "$DOMINO_CONFIG_DIR"/latest-mainnet-beta-snapshot
mkdir -p "$DOMINO_CONFIG_DIR"/latest-mainnet-beta-snapshot
(
...
$domino_ledger_tool create-snapshot \
  --ledger "$DOMINO_CONFIG_DIR"/latest-mainnet-beta-snapshot \
