use {
    ...
    domino_cli_output::{parse_sign_only_reply_string, OutputFormat},
    domino_client::{
    ...
    domino_vote_program::vote_state::{VoteAuthorize, VoteState, VoteStateVersions},
};
...
fn test_vote_authorize_and_withdraw() {
    ...
    let destination_account = domino_sdk::pubkey::new_rand(); // Send withdrawal to new account to make balance check easy
