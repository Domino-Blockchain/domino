...
then about 1,000 lines of changes is about the most you should ask a Domino
...
is ready to be integrated, the Domino maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the Domino
...
Domino's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.dominochain.com/proposals/accepted-design-proposals)
section of the Domino docs.  Here's the full process:
