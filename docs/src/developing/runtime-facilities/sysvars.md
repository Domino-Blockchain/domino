...
Domino exposes a variety of cluster state data to programs via
...
[`domino-program`
crate](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/domino-program/VERSION_FOR_DOCS_RS/domino_program/stake_history/struct.StakeHistory.html)
