...
There is no strict minimum amount of DOMI required to run a validator on Domino.
...
releases at [dominolabs/domino](https://hub.docker.com/r/dominolabs/domino).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Domino](../cli/install-domino-cli-tools.md) for the current Domino software release.
...
CUDA is required to make use of the GPU on your system. The provided Domino
